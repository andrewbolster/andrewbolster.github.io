...
\urlstyle{same}\url{${( profile.url )}$} \\ % Your website, LinkedIn profile or other web address
\href{mailto:${( profile.email)}$}{${(profile.email )}$} | ${( profile.mobile )}$ % Your contact information
}
