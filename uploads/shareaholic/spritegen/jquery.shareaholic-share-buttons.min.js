...
if(typeof SHRTB_Settings!="undefined"&&typeof SHRTB_Settings.shr_twitter_template!="undefined")SHR4P.TB.shr_twitter_template=SHRTB_Settings.shr_twitter_template;SHR4P.debug=function(a){SHR4P.debug_enabled&&(typeof console!="undefined"&&console?console.log(a):alert(a))};SHR4P.TB.ready=!1;SHR4P.TB.init=!1;
...
k=a("document").height()/4||120,i=!1;a("<style type='text/css'>#shareToolBar,#showHideToolBar,#shareToolBarAddv,#shareToolBarHeader{background-color: "+(f||"#343434")+" !important;} .shareToolBarShowButton{ background-image: url("+SHR4P.TB.shr_image_arrow_down+") !important;}.shareToolBarHideButton{background-image: url("+SHR4P.TB.shr_image_arrow_up+") !important;}#shareaholic-bar{border-bottom-color:"+(h||"#343434")+"} </style>").appendTo("head");var f=a("<div id='shareToolBarHeader'></div>"),g=
a("<div id='shareToolBarContainer'></div>"),h=a("<div id='shareToolBarFooter'></div>"),d=a("<div id='shareaholic-bar' class='shareToolBarShadow' style='display:none'></div>"),l=a("<div id='shareToolBar'></div>");b.wrap(l);l=b.parents("#shareToolBar");l.wrap(g);g=l.parents("#shareToolBarContainer");g.wrap(d);d=g.parents("#shareaholic-bar");f.prependTo(d);h.appendTo(d);f=b.parents("#shareaholic-bar");SHR4P.debug(f);a('<div id="showHideToolBar" title="Click to hide the toolbar"><div class="shareToolBarButton shareToolBarHideButton"></div></div>').appendTo(g);
a('<div id="shareToolBarAddv"></div>').appendTo(g);var m=a("#shareaholic-bar"),j=a("#showHideToolBar");j.click(function(){i=!i;a("#showHideToolBar > div").toggleClass("shareToolBarShowButton shareToolBarHideButton");i?(j.hide(),a("#shareaholic-bar").css("border-bottom-width","0px").removeClass("shareToolBarShadow")):j.css("margin-left","-100%");a("#shareToolBar, #shareToolBarAddv").slideToggle("slow",function(){i||(a("#shareaholic-bar").css("border-bottom-width","1px").addClass("shareToolBarShadow"),
a("#shareToolBarHeader").animate({height:"+=5"},{duration:100}).animate({height:"-=5"},{duration:100}));var b=a("#showHideToolBar").css("margin-left");i&&b!="0px"&&(j.css("margin-left","0"),j.fadeIn("slow"))})});a(window).scroll(function(){var b=a(window).scrollTop(),c=m.css("display")=="none";SHR4P.debug("ScrollTop "+b+" ScrollOffset: "+k);b>k?c&&a("#shareaholic-bar,#shareToolBar, #shareToolBarAddv").slideDown("slow",function(){a("#shareToolBarHeader").animate({height:"+=5"},{duration:100}).animate({height:"-=5"},
{duration:100});a("#shareaholic-bar").css("border-bottom-width","1px").addClass("shareToolBarShadow");j.fadeIn("slow")}):i||(j.hide(),a("#shareaholic-bar").css("border-bottom-width","0px").removeClass("shareToolBarShadow"),a("#shareaholic-bar,#shareToolBar, #shareToolBarAddv, #showHideToolBar").slideUp("slow"))})}}}(SHR4P.TB.jQuery),SHR4P.TB.ready=!0,typeof SHR4P.TB.onready!="undefined")SHR4P.TB.onready()};
...
4))},getFbShrCnt:function(a,b){a="http://api.ak.facebook.com/restserver.php?v=1.0&method=links.getStats&format=json&urls="+encodeURIComponent(a);SHR4P.TB.jQuery.getJSON(a+"&callback=?",function(a){var e=0;if(a.length>0)e=a[0].total_count,e!=0&&e>1E3&&(e=Math.floor(e/1E3)+"K");b({count:e})})},getTwitShrCnt:function(a,b){a="http://urls.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(a);SHR4P.TB.jQuery.getJSON(a+"&callback=?",function(a){a=a.count;a!=0&&a>1E3&&(a=Math.floor(a/1E3)+"K");b({count:a})})}};
...
".shareaholic-like-buttonset").each(function(){var a=SHR4P.TB.jQuery(this),b=a.attr("data-shr_href")||a.attr("shr_href"),c=a.attr("data-shr_title")||a.attr("shr_title"),e=a.attr("data-shr_size")||a.attr("shr_size"),d=a.attr("data-shr_count")||a.attr("shr_count"),f=a.attr("data-shr_annotation"),h=a.attr("data-shr_width"),k=a.attr("data-shr_expandto"),i=a.attr("data-shr_onstartinteraction"),g=a.attr("data-shr_onendinteraction");if(typeof d=="undefined"||!d)d="true";if((typeof b=="undefined"||!b)&&(typeof c==
"undefined"||!c))b=encodeURIComponent(document.location.href),c=document.title;else{if(typeof b=="undefined"||!b)b=encodeURIComponent(document.location.href);if(typeof c=="undefined"||!c)c=""}if(typeof e=="undefined"||!e)e="standard";if(typeof f=="undefined"||!f)f="inline",f=typeof d!=="undefined"&&d&&d!=="false"?"inline":"none";if(typeof h=="undefined"||!h)h="450px";if(typeof k=="undefined"||!k)k="";if(typeof i=="undefined"||!i)i="";if(typeof g=="undefined"||!g)g="";d="";e=="medium"&&(d="padding-top:1px !important;");
d=SHR4P.TB.jQuery("<div style='float:left; "+d+" margin:0px 0px 0px 10px !important;'/>").get(0);a.replaceWith(d);SHR4P.TB.jQuery(d).append("<div/>");d=SHR4P.TB.jQuery(d).find(":first-child").get(0);gapi.plusone.render(d,{size:e,annotation:f,width:h,expandto:k,onstartinteraction:i,onendinteraction:g,href:decodeURIComponent(b),callback:function(a){SHR4P.TB.googPlusOneUtil.trackPlusOneClick(a,c)}})})},trackPlusOneClick:function(a,b){a.state=="on"&&SHR4P.TB.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey="+
SHR4P.TB.shr_apiKey+"&apitype=3&service=304&link="+encodeURIComponent(a.href)+(b!==""?"&title="+b:""),width:"1",height:"1"}).appendTo("body")}};
SHR4P.TB.twitterUtil={addTwitterScript:function(){SHR4P.TB.twitterUtil.renderShareaholicTweetButton()},renderShareaholicTweetButton:function(){SHR4P.TB.jQuery(".shareaholic-tweetbutton",".shareaholic-like-buttonset").each(function(){var a=SHR4P.TB.jQuery,b=a(this),c=b.attr("data-shr_href")||b.attr("shr_href"),e=b.attr("data-shr_title")||b.attr("shr_title"),d=b.attr("data-shr_size")||b.attr("shr_size"),f=b.attr("data-shr_count")||b.attr("shr_count"),h=b.attr("data-shr_lang"),k="shr-7",i="shr-generic",
g=!0,l=!0;SHR4P.debug(b);if(typeof f=="undefined"||!f)f="horizontal";if((typeof c=="undefined"||!c)&&(typeof e=="undefined"||!e))c=encodeURIComponent(document.location.href),e=document.title;else{if(typeof c=="undefined"||!c)c=encodeURIComponent(document.location.href);if(typeof e=="undefined"||!e)e=""}if(typeof d=="undefined"||!d)d="standard";var m="";d=="medium"&&(m="padding-top:1px !important;");if(typeof h=="undefined"||!h)h="en";switch(f){case "horizontal":l=g=!0;break;case "vertical":g=!0;l=
!1;break;case "none":l=g=!1}g&&(k+="-count",i+="-count");g&&l&&(k+="-compact",i+="-compact");if(g){var j=this;if(l)this.style.marginRight="0px",d=document.createElement("div"),j=document.createElement("div"),f=this.parentNode,f.appendChild(j),j.className="shr_compact_div",d.className="shr_compact_tick",d.appendChild(document.createElement("s")),d.appendChild(document.createElement("i")),f.insertBefore(d,j);g&&SHR4P.TB.utils.getTwitShrCnt(c,function(a){j.innerHTML=a.count})}var n={title:e,link:c,short_link:c,
shortener:SHRTB_Settings.shortener?SHRTB_Settings.shortener:"google",shortener_key:SHRTB_Settings.shortener_key?SHRTB_Settings.shortener_key:"",v:1,apitype:1,apikey:SHR4P.TB.shr_apiKey,twitter_template:SHR4P.TB.shr_twitter_template?SHR4P.TB.shr_twitter_template:"${title} - ${short_link}",service:7};[SHR4P.TB.shr_link,a.param(n)].join("?");a(this).before(a('<style type="text/css"> div.shareaholic a{background-image:url('+SHR4P.TB.shr_image+") !important;}.shr-generic-count{height:53px;width:57px;font-weight:bold;font-size:14px;padding-top:7px;text-align:center;background:transparent no-repeat scroll;background-position:0px -80px;color:black;cursor:pointer;text-decoration:none;display:block;}.shr-generic-count-compact,.shr-generic{height:23px;width:63px;font-weight:bold;font-size:14px;padding-top:7px;text-align:center;background:transparent no-repeat scroll;background-position:0px -50px;color:black;cursor:pointer;text-decoration:none;display:block;}.shr-7-count{background-position:-57px -80px;}.shr-7-count-compact,.shr-7{height:14px;width:55px;background-position:-228px -79px;}</style>"));
b.wrap('<div class="shr-7 shareaholic" style="float:left; '+m+' margin:0px 0px 0px 10px !important;"></div>');b.parent().removeClass("shr-7");b.addClass(i);b.addClass(k);SHR4P.debug(b);SHR4P.TB.utils.isMobileBrowser()||b.click(function(a){SHR4P.TB.utils.showServiceLet(n,"twitter");a.preventDefault()})})},trackTweetButtonClick:function(a){a.type="tweet";SHR4P.TB.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey="+SHR4P.TB.shr_apiKey+"&apitype=3&service=7&link="+encodeURIComponent(a.target.baseURI)+
