...
\namesection{${( profile.firstName )}$}{${( profile.lastName )}$}{ % Your name
\urlstyle{same}\url{${( profile.urls.personal )}$} \\ % Your website, LinkedIn profile or other web address
\href{mailto:${( profile.emailAddress)}$}{${(profile.emailAddress )}$} | ${( profile.phoneNumbers.mobile )}$ % Your contact information
}
